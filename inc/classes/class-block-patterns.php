...
class Block_Patterns {
	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'nintynine/cover',
				[
					'title' => __( 'Nintynine Cover', 'nintynine' ),
					'description' => __( 'Nintynine Cover Block with image and text', 'nintynine' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'nintynine/two-columns',
				[
					'title' => __( 'Nintynine Two Column', 'nintynine' ),
					'description' => __( 'Nintynine two columns with heading and text', 'nintynine' ),
					'categories' => [ 'columns' ],
	...
	public function register_block_pattern_categories() {
		...
		$pattern_categories = [
			'cover' => __( 'Cover', 'nintynine' ),
			'columns' => __( 'Columns', 'nintynine' ),
		];
