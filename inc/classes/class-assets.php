...
class Assets {
    ...
    public function register_styles(){
        ...
        wp_register_style( 'slick-css', NINTYNINE_BUILD_LIB_URI . '/css/slick.css', [], false, 'all' );
        wp_register_style( 'slick-theme-css', NINTYNINE_BUILD_LIB_URI . '/css/slick-theme.css', ['slick-css'], false, 'all' );
        ...
        wp_register_style( 'search-css', NINTYNINE_BUILD_CSS_URI . '/search.css', [], filemtime( NINTYNINE_BUILD_CSS_DIR_PATH . '/search.css' ), 'all' );
    ...
    public function register_scripts(){
        //Register Scripts
        wp_register_script( 'slick-js', NINTYNINE_BUILD_LIB_URI . '/js/slick.min.js', ['jquery'], false, true );
        wp_register_script( 'main-js', NINTYNINE_BUILD_JS_URI . '/main.js', ['jquery'], filemtime( NINTYNINE_BUILD_JS_DIR_PATH . '/main.js' ), true );
        wp_register_script( 'single-js', NINTYNINE_BUILD_JS_URI . '/single.js', ['jquery', 'slick-js'], filemtime( NINTYNINE_BUILD_JS_DIR_PATH . '/single.js' ), true );
		wp_register_script( 'author-js', NINTYNINE_BUILD_JS_URI . '/author.js', ['jquery'], filemtime( NINTYNINE_BUILD_JS_DIR_PATH . '/author.js' ), true );
		wp_register_script( 'search-js', NINTYNINE_BUILD_JS_URI . '/search.js', ['main-js'], filemtime( NINTYNINE_BUILD_JS_DIR_PATH . '/search.js' ), true );
