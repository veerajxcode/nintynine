...
<div id="primary">
	<main id="main" class="site-main mt-5" role="main">
		<nintynine-search class="nintynine-search row px-4">
			<nintynine-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
				<nintynine-clear-all-filters class="clear-all-filters"><button class="btn btn-secondary">Clear All filters</button></nintynine-clear-all-filters>
				<?php foreach ( $filters_data as $filter_data ) : ?>
					<nintynine-checkbox-accordion
					...
					>
						...
						<nintynine-checkbox-accordion-content class="checkbox-accordion__content">
							<?php foreach ( $filter_data['children'] as $item ) : ?>
								...
								<?php if ( ! empty( $item['label'] ) ) : ?>
									<nintynine-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
											...
											<div class="checkbox-accordion__child-content">
												<?php foreach ( $item['children'] as $child ) : ?>
													...
													<?php if ( ! empty( $child['label'] ) && ! empty( $child['value'] ) ) : ?>
														<nintynine-checkbox-accordion-child class="checkbox-accordion__child">
															<div class="checkbox-accordion__child-handle form-field">
																	...
																	<?php foreach ( $child['children'] as $grand_children ) : ?>
																		...
																		<?php if ( ! empty( $grand_children['label'] ) && ! empty( $grand_children['value'] ) ) : ?>
																			<nintynine-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
																				...
																				<?php endif; ?>
																			</nintynine-checkbox-accordion-child>
																		<?php endif; ?>
																	<?php endforeach; ?>
																</div>
															<?php endif; ?>
								...
								<?php endif; ?>
							<?php endforeach; ?>
						</nintynine-checkbox-accordion-content>
					</nintynine-checkbox-accordion>
				<?php endforeach; ?>
			</nintynine-filters>
			<div class="col-lg-9 col-md-9 col-sm-12 pb-4">
				<nintynine-results-count class="nintynine-results-count"></nintynine-results-count>
				<nintynine-results class="row"></nintynine-results>
				<nintynine-loading-more class="nintynine-loading-more"></nintynine-loading-more>
			</div>
		</nintynine-search>
	</main>
</div>
